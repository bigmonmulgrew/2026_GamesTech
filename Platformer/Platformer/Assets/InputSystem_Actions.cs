...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Debugging"",
            ""id"": ""487b6bb4-0a9b-4309-9ed5-352d065ce0d8"",
            ""actions"": [
                {
                    ""name"": ""WinLevel"",
                    ""type"": ""Button"",
                    ""id"": ""2466e310-44a1-4218-90e2-ebf9857b0f82"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""LoseLevel"",
                    ""type"": ""Button"",
                    ""id"": ""95a38bf0-acc9-4749-b7a1-ee789fa1f762"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""041e90fe-b9c5-4cb5-b6ee-07b8b81e5490"",
                    ""path"": ""<Keyboard>/1"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Gamepad"",
                ...
                {
                    ""name"": """",
                    ""id"": ""a5e54131-eefa-4c3d-9f23-624fd050303e"",
                    ""path"": ""<Keyboard>/2"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Gamepad"",
    ...
    ""controlSchemes"": [
        ...
        m_Debugging_WinLevel = m_Debugging.FindAction("WinLevel", throwIfNotFound: true);
        m_Debugging_LoseLevel = m_Debugging.FindAction("LoseLevel", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Debugging.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Debugging.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Debugging_WinLevel;
    private readonly InputAction m_Debugging_LoseLevel;
    /// <summary>
    ...
    public struct DebuggingActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public DebuggingActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Debugging/WinLevel".
        /// </summary>
        public InputAction @WinLevel => m_Wrapper.m_Debugging_WinLevel;
        /// <summary>
        /// Provides access to the underlying input action "Debugging/LoseLevel".
        /// </summary>
        public InputAction @LoseLevel => m_Wrapper.m_Debugging_LoseLevel;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        ...
        public void AddCallbacks(IDebuggingActions instance)
        {
            ...
            @WinLevel.started += instance.OnWinLevel;
            @WinLevel.performed += instance.OnWinLevel;
            @WinLevel.canceled += instance.OnWinLevel;
            @LoseLevel.started += instance.OnLoseLevel;
            @LoseLevel.performed += instance.OnLoseLevel;
            @LoseLevel.canceled += instance.OnLoseLevel;
        }
    ...
    {
        /// <summary>
        /// Method invoked when associated input action "WinLevel" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnWinLevel(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "LoseLevel" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnLoseLevel(InputAction.CallbackContext context);
    }
}
